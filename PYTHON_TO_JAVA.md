...
- Use `genai-ws/exercises/java/PromptEngineering.java` as the template for new translations, mirroring its picocli setup, Javadoc/Markdown structure, and file layout. put the new java file into `genai-ws/exercises/java/`
