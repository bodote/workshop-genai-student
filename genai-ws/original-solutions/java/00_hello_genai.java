 ...
 */
    ...
    public Integer call() throws Exception {
       ...
       // TODO: Generate response by calling the generate_content method from client.models. 
       // Use the model, user prompt and config as parameters.

        GenerateContentResponse resp = client.models.generateContent(MODEL, USER_PROMPT, config);
        out.println("output: %s".formatted(resp.candidates().orElseThrow().get(0).content().orElseThrow().text()));
